"""
Django settings for economic_comparison project.
...
environ.Env.read_env(os.path.join(BASE_DIR, "data", ".env"))
...
ROOT_URLCONF = 'economic_comparison.urls'
...
WSGI_APPLICATION = 'economic_comparison.wsgi.application'
